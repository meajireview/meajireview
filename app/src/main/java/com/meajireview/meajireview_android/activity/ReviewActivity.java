    ...
    private void makeList() {
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> list, ParseException e) {
                ...
                ReviewHeader reviewHeader =null;
                for(ParseObject o : list){
                    Log.e("ddd", ""+list.size());
                    if(isLogined && o.getString("reviewer").equals(finalUserName)) {
                        reviewHeader = new ReviewHeader(getIntent().getIntExtra("shopId",-1),o.getBoolean("is_recommend"), o.getString("contents"),o.getObjectId());
                        Log.e("ddd", ""+o.getString("contents"));
                    }
                    reviewItems.add(new ReviewItem(getIntent().getIntExtra("shopId",-1),o.getBoolean("is_recommend"), o.getString("contents"),o.getString("reviewer")));
                    Log.e("ddd", ""+o.getString("contents"));
                }
                if(reviewHeader==null)
                    reviewHeader = new ReviewHeader(getIntent().getIntExtra("shopId",-1), true, "","");
